...
import { Avatar, Picture, SpeechBubbleDirection } from '@gamepark/react-game'
  ...
  return (
    ...
    <div css={[avatarStyle, roundBorders]}>
      {(playerInfo?.avatar)
        ...
        : <Picture src={Images.oustiti} css={[roundBorders, toFullSize, ouistitiStyle]} draggable={false}/>
      }
    </div>
